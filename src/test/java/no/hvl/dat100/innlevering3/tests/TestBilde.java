...
public class TestBilde {
    ...
    public void testConstructor1() {
        Bilde bilde = new Bilde("Ole Olsen", "23-10","et bilde","http://www.picture.com/oo.jpg");
    ...
    public void testConstructor2() {
        Bilde bilde = new Bilde("Ole Olsen", "23-10",7,"et bilde","http://www.picture.com/oo.jpg");
        assertEquals("Ole Olsen", bilde.bruker());
        assertEquals("23-10", bilde.dato());
